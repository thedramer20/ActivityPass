...
print_status "     - Startup Command: bash -c \"source .venv/bin/activate && python manage.py runserver 0.0.0.0:8000\""
print_status ""
...
print_status "   cd $DEPLOY_DIR && source .venv/bin/activate && python manage.py runserver 127.0.0.1:8000    # Start backend"
